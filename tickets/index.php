...
<body>
<div><a href="index.php">Home</a> | <a href="newticket.php">Upload a new ticket</a> | <a href="logout.php">Log out</a></div>
<table>
<tr>
<td>
<table>
...
<tr><td><button name="create" id="create" value="create">Submit</button>
